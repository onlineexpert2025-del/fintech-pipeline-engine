...
import { Button, Snackbar, Dialog, Portal, IconButton } from 'react-native-paper';
...
export const ResultScreen: React.FC = () => {
  ...
  const addSplitEntry = () => {
    setSplitEntries([...splitEntries, { category: '', amount: '' }]);
  };
    ...
    <SafeAreaView style={styles.container} edges={['bottom']}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.fieldContainer}>
            <Text style={styles.fieldLabel}>Date (Device Date)</Text>
            <Text style={styles.fieldValue}>
              {new Date(deviceDate).toLocaleDateString('en-US', { 
                weekday: 'short', 
                month: 'short', 
                day: 'numeric', 
                year: 'numeric',
      ...
      <Portal>
        <Dialog visible={showDuplicateDialog} onDismiss={() => setShowDuplicateDialog(false)}>
          ...
          <Dialog.Title style={styles.dialogTitle}>Duplicate Receipt?</Dialog.Title>
          <Dialog.Content>
          ...
          <Dialog.Actions>
            <Button onPress={() => setShowDuplicateDialog(false)}>Cancel</Button>
            <Button 
              onPress={() => {
      ...
      >
        <SafeAreaView style={styles.modalContainer}>
          <View style={styles.modalHeader}>
            ...
            />
            <Text style={styles.modalTitle}>Split Receipt</Text>
            <View style={{ width: 48 }} />
          </View>
